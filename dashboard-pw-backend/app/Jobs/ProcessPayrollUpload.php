...
class ProcessPayrollUpload implements ShouldQueue
{
    ...
    protected function mapPayrollFields(array $record): array
    {
        return [
            ...
            'noktp' => $record['noktp'] ?? null,
            // Tunjangan
            'gaji_pokok' => (float) ($record['gapok'] ?? 0),
            'tunj_istri' => (float) ($record['tjistri'] ?? 0),
            'tunj_anak' => (float) ($record['tjanak'] ?? 0),
            'tunj_fungsional' => (float) ($record['tjfungsi'] ?? 0),
            'tunj_struktural' => (float) ($record['tjstruk'] ?? 0),
            'tunj_umum' => (float) ($record['tjumum'] ?? 0),
            'tunj_beras' => (float) ($record['tjberas'] ?? 0),
            'tunj_pph' => (float) ($record['tjpajak'] ?? 0),
            'tunj_tpp' => (float) ($record['tjtpp'] ?? 0),
            'tunj_eselon' => (float) ($record['tjeselon'] ?? 0),
            'tunj_guru' => (float) ($record['tjguru'] ?? 0),
            'tunj_langka' => (float) ($record['tjlangka'] ?? 0),
            'tunj_tkd' => (float) ($record['tjtkd'] ?? 0),
            'tunj_terpencil' => (float) ($record['tjterpencil'] ?? 0),
            'tunj_khusus' => (float) ($record['tjkhusus'] ?? 0),
            'tunj_askes' => (float) ($record['tjaskes'] ?? 0),
            'tunj_kk' => (float) ($record['tjkk'] ?? 0),
            'tunj_km' => (float) ($record['tjkm'] ?? 0),
            'pembulatan' => (float) ($record['tbulat'] ?? 0),
            'kotor' => (float) ($record['kotor'] ?? 0),
            // Potongan
            'pot_iwp' => (float) ($record['piwp'] ?? 0),
            'pot_iwp1' => (float) ($record['piwp1'] ?? 0),
            'pot_iwp8' => (float) ($record['piwp8'] ?? 0),
            'pot_askes' => (float) ($record['paskes'] ?? 0),
            'pot_pph' => (float) ($record['ppajak'] ?? 0),
            'pot_bulog' => (float) ($record['pbulog'] ?? 0),
            'pot_taperum' => (float) ($record['ptaperum'] ?? 0),
            'pot_sewa' => (float) ($record['psewa'] ?? 0),
            'pot_hutang' => (float) ($record['phutang'] ?? 0),
            'pot_korpri' => (float) ($record['pkorpri'] ?? 0),
            'pot_irdhata' => (float) ($record['pirdhata'] ?? 0),
            'pot_koperasi' => (float) ($record['pkoperasi'] ?? 0),
            'pot_jkk' => (float) ($record['pjkk'] ?? 0),
            'pot_jkm' => (float) ($record['pjkm'] ?? 0),
            'total_potongan' => (float) ($record['potongan'] ?? 0),
            'bersih' => (float) ($record['bersih'] ?? 0),
        ];
    }
