            ...
            <v-card class="glass-card rounded-xl overflow-hidden" elevation="0">
              ...
              >
                ...
                <template v-slot:item.jenis_gaji="{ item }">
                  <v-chip size="x-small" :color="item.jenis_gaji === 'Induk' ? 'teal' : 'orange'" variant="tonal" class="font-weight-bold">
        ...
        <v-card-text class="pa-6">
          <v-form ref="formRef" v-model="formValid">
            <v-row dense>
              ...
              <v-col cols="12" md="3">
                <v-text-field v-model.number="form.bersih" label="Penghasilan Bersih" type="number" variant="outlined" density="compact" prefix="Rp" readonly bg-color="teal-lighten-5"></v-text-field>
              </v-col>
            </v-row>
          </v-form>
        </v-card-text>
