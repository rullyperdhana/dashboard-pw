...
const menuItems = ref([
  ...
  },
  {
    ...
    children: [
      { title: 'Dashboard PW', icon: 'mdi-view-dashboard-outline', value: 'pw-dashboard', to: '/dashboard-pppk-pw' },
      { title: 'Laporan Bulanan PW', icon: 'mdi-file-table-outline', value: 'pw-report-monthly', to: '/reports/pppk-pw-monthly' },
      { title: 'Laporan Periodik PW', icon: 'mdi-calendar-range', value: 'pw-report-periodic', to: '/reports/pppk-pw-periodic' },
      { title: 'Pegawai PW', icon: 'mdi-account-group-outline', value: 'pw-employees', to: '/employees' },
      { title: 'Payroll PW', icon: 'mdi-wallet-outline', value: 'pw-payments', to: '/payments' },
  ...
  },
  {
    ...
    children: [
      { title: 'Dashboard PNS', icon: 'mdi-view-quilt-outline', value: 'pns-dashboard', to: '/pns' },
      { title: 'Update NIK Massal', icon: 'mdi-account-plus-outline', value: 'pns-import-nik', to: '/employees/import-nik' },
      ...
      { title: 'Master Pegawai (DBF)', icon: 'mdi-master-pegawai', to: '/master-pegawai' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Estimasi JKK/JKM', icon: 'mdi-shield-check-outline', value: 'jkk-jkm-settings', to: '/settings/pppk' },
  ...
  },
  {
    ...
    icon: 'mdi-chart-pie',
    children: [
      { title: 'Input Anggaran', icon: 'mdi-cash-plus', value: 'budget-input', to: '/budget/input' },
      { title: 'Laporan Realisasi', icon: 'mdi-file-chart-outline', value: 'budget-report', to: '/budget/report' },
    ]
  },
  {
    ...
    children: [
      { title: 'SKPD PW', icon: 'mdi-office-building-outline', value: 'skpd-pw', to: '/skpd' },
      { title: 'SKPD Mapping', icon: 'mdi-skpd-mapping', to: '/settings/skpd-mapping' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Manajemen User', icon: 'mdi-account-group-outline', value: 'user-management', to: '/settings/users', roles: ['superadmin'] },
      { title: 'Manajemen Group', icon: 'mdi-account-details-outline', value: 'group-management', to: '/settings/groups', roles: ['superadmin'] },
      ...
      { title: 'Rekon Data BKD', icon: 'mdi-bkd-recon', to: '/settings/bkd-recon', roles: ['superadmin', 'operator'] },
